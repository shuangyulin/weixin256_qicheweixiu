<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#3A78F1","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#06A9FF","fontSize":"40rpx"}'>
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#06A9FF","borderColor":"#3A78F1","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
